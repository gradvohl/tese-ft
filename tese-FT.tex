...
% 
% Última versão: 06/julho/2018
%
% Adições/Alterações nesta última versão
% - Substituição do Biblatex com ABNT ao invés do bibtex original
% - A maioria dos pacotes necessários foram movidos para o arquivo
%   tese-FT.cls
% - Apêndices no final
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
