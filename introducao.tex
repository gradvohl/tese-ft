...
Veja um exemplo de equação no próprio texto, e.g., $x=\frac{\sqrt{a^{2}+b^{2}}}{\sigma}$.  Se você preferir, pode escrever a equação de forma estendida, conforme a \Equacao{eq:teste} a seguir. Note que o rótulo é colocado automaticamente.
...
Veja a seguir o comando para criar uma figura e o resultado, na \Figura{fig:xwing}. Dica importante: sempre que possível, use figuras no formato PDF. De acordo com o Overleaf, isso acelera a compilação do texto, sem perder a qualidade da figura.
...
Por exemplo, respectivamente, \Sigla{Ácido Desoxirribonucleico}{DNA} ou \SiglaHifen{Ácido Desoxirribonucleico}{DNA}. A lista de siglas é adicionada automaticamente.
